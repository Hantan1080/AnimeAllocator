// src/lib.rs
/*
 * Core library for AnimeAllocator
 */
...
#[derive(Debug)]
pub struct AnimeAllocatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeAllocatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeAllocator processing");
    
    let mut processor = AnimeAllocatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeAllocatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeAllocatorProcessor::new(false);
